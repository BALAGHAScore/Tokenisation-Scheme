...
&nbsp;
## 🔢 Changelog
🏷️ **2025-12-10 - [v0.1.0](https://github.com/BALAGHAScore/Tokenisation-Scheme/tree/v0.1.0) (First public release)**  
This is the first public, versioned release of the Arabic Word Tokenisation Scheme with full documentation ([PDF](Arabic_Word_Tokenisation_Scheme_v0.1.0.pdf)) and example workflows.
